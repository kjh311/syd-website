...
var homeButton = document.querySelectorAll(
  "#nav_section>.no_subcontent:nth-child(1)>a"
);
...
askInner.innerHTML =
  "<a href='/about-us'>About Us</a><a href='/vision'>Our Vision</a><a href='/our-people'>Our People</a><a href='/board'>Board of Directors</a><a href='/clergy'>Clergy</a><a href='/staff'>Staff</a><a href='/our-location'>Our Location</a><a href='/directions'>Directions</a><a href='/our-history'>Our History</a><a href='/membership-form'>Join our Community</a><a href='/contact-us'>Contact Us</a>";

var prayInner = document.getElementById("dropdown-content-2");
prayInner.innerHTML =
  "<a href='/worship'>Worship</a><a href='/livestream'>Livestream</a><a href='/participate'>Participate</a><a href='/oneg-kiddush'>Sponsor an Oneg or Kiddush Luncheon</a><a href='/bnai-mitzvah'>B-Mitzvah Process</a><a href='/yahrzeits'>Yahrzeits</a>";

var playInner = document.getElementById("dropdown-content-3");
playInner.innerHTML =
  "<a href='/live'>Live</a><a href='/high-holidays'>High Holidays</a><a href='/chavurot-2'>TBT Committees</a><a href='/interest-groups'>Interest Groups</a><a href='/sisterhood'>Sisterhood</a>";

var actInner = document.getElementById("dropdown-content-4");
actInner.innerHTML =
  "<a href='/tikun-olam'>Social Action</a><a href='/homelessness'>Combat Homelessness</a><a href='/fighting-hunger'>Fight Hunger</a><a href='/racial-equality'>Racial Equality</a><a href='/gun-responsibility'>Gun Responsibility</a><a href='/immigrant-rights'>Immigrant Rights</a><a href='/pride'>Pride at TBT</a><a href='/mitzvah-corps'>Mitzvah Corp</a><a href='/environmental-justice'>Environmental Justice</a><a href='/vaccine'>Vaccine Awareness</a><a href='/volunteer'>Volunteer</a>";

var learnInner = document.getElementById("dropdown-content-5");
learnInner.innerHTML =
  "<a href='/learn'>Lifelong Learning</a><a href='/tots'>Tots</a><a href='/kids'>Kids</a><a href='/teens'>Teens</a><a  href='/adults'>Adults</a><a href='/bnai-mitzvah'>B-Mitzvah Process</a>";

var joinInner = document.getElementById("dropdown-content-6");
joinInner.innerHTML =
  "<a href='/community'>Community</a><a href='/membership-form'>Connect</a><a href='/membership'>Membership</a><a  href='/judaica'>Judaica Shop</a>";
...
if (viewportWidth > 767) {
  firstNavLink.innerHTML =
    '<img class="home-svg"  src="https://images.shulcloud.com/14479/uploads/home-icon-silhouette-blue.svg">';
...
if ("onhashchange" in window && window.screen.width > 767) {
  ...
  facebook.innerHTML =
    '<li><i class="fa fa-facebook-official" style="font-size:30px"></i></li>';
  ul.appendChild(facebook);

  youtube = document.createElement("a");
  youtube.setAttribute(
    "href",
    "https://www.youtube.com/channel/UCAI8ituiK8qcOwQIdV7wVdw"
  );
  youtube.setAttribute("id", "youtube-nav-icon");
  youtube.setAttribute("class", "navbar-top-links");
  youtube.innerHTML =
    '<li><i class="fa fa-youtube" style="font-size:30px"></i></li>';
  ...
  newsletter.setAttribute("href", "/member/subscriptions");
  newsletter.setAttribute("id", "newsletter-nav");
  newsletter.setAttribute("class", "navbar-top-links-text");
  newsletter.innerHTML = "Newsletter";
  ul.appendChild(newsletter);
  ...
  searchIcon.innerHTML =
    '<button onclick="openSearchBar()" class="search-submit-button" ><i class="fa fa-search fa-search-1"></i></button>';
...
if ("onhashchange" in window && window.screen.width < 767) {
  ...
  searchMobileLi.innerHTML =
    '<a href="#" onclick="openSearchBar()" class="search-mobile-button">Search</a>';
  navSection.appendChild(searchMobileLi);

  //add newsletter to mobile dropdown
  newsletterMobileLi = document.createElement("li");
  newsletterMobileLi.setAttribute(
    "class",
    "newsletter-mobile-li no_subcontent"
  );
  newsletterMobileLi.innerHTML =
    '<a href="/member/subscriptions" class="newsletter-mobile-button">Newsletter</a>';
  navSection.appendChild(newsletterMobileLi);
}
...
if (current == "/") {
  ...
  current == "/clergy" ||
  current == "/staff" ||
  current == "/our-location" ||
  current == "/kashrut-policy" ||
  current == "/rosen-ritt-library" ||
  current == "/directions" ||
  current == "/our-history" ||
  current == "/wall-of-connections" ||
  current == "/join-our-community" ||
  current == "/visitors" ||
  current == "/contact-us"
) {
  var viewportWidth = window.innerWidth || document.documentElement.clientWidth;
  ...
  current == "/services" ||
  current == "/tefilab" ||
  current == "/shabbat-in-the-park" ||
  current == "/shabbat-nefesh" ||
  current == "/livestream" ||
  current == "/participate" ||
  current == "/oneg-kiddush" ||
  current == "/bnai-mitzvah" ||
  current == "/yahrzeits"
) {
  var viewportWidth = window.innerWidth || document.documentElement.clientWidth;
  ...
  current == "/live" ||
  current == "/high-holidays" ||
  current == "/sisterhood" ||
  current == "/sisterhood-contact" ||
  ...
  current == "/volunteer" ||
  current == "/mitzvah-corps" ||
  current == "/tikun-olam-2" ||
  current == "/fighting-hunger" ||
  current == "/racial-equality" ||
  current == "/gun-responsibility" ||
  current == "/immigrant-rights" ||
  current == "/pride" ||
  current == "/vaccine"
) {
  var viewportWidth = window.innerWidth || document.documentElement.clientWidth;
